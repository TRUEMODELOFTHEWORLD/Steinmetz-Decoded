...
<div class="source-matrix">
  <a href="/source-texts/theory-calculation-electric-apparatus/chapter-10/">Read the source chapter<span>Open the OCR-derived apparatus chapter on the hysteresis motor.</span></a>
  <a href="/chapter-workbench/theory-calculation-electric-apparatus/chapter-10/">Open the chapter workbench<span>Review equation candidates, figure references, concepts, glossary terms, and promotion tasks.</span></a>
  <a href="/diagrams/visual-topic-galleries/magnetism-hysteresis-machines/">Open magnetic-machine visuals<span>Use rotating-field and hysteresis visuals as modern guides, not source substitutes.</span></a>
  <a href="/mathematics/equation-atlas/magnetism-hysteresis/">Open hysteresis formulas<span>Review source-routed formula candidates tied to hysteresis and magnetic loss.</span></a>
</div>
...
- [Hysteresis Loop and Loss Tool](/tools/#hysteresis-loop-and-steinmetz-loss)
