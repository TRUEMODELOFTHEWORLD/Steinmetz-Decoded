...
<div class="source-matrix">
  <a href="/source-texts/theory-calculation-transient-electric-phenomena-oscillations/chapter-15/">Read line-wave source text<span>Start with the first routed chapter in the standing/traveling wave sequence.</span></a>
  <a href="/chapter-workbench/theory-calculation-transient-electric-phenomena-oscillations/chapter-15/">Open the chapter workbench<span>Review equation candidates, figure candidates, glossary hits, and promotion tasks.</span></a>
  <a href="/diagrams/visual-topic-galleries/transients-surges-oscillations/">Open wave and surge visuals<span>Use distributed-line, surge-reflection, and transient-response visual routes together.</span></a>
  <a href="/mathematics/equation-atlas/transients-oscillation/">Open transient formula family<span>Review candidate equations for oscillation, damping, natural period, and distributed lines.</span></a>
</div>
