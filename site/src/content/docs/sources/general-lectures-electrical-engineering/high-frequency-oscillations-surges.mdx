...
<div class="source-matrix">
  <a href="/source-texts/general-lectures-electrical-engineering/lecture-07/">Read the source lecture<span>Open the OCR-derived Lecture VII text before relying on this summary.</span></a>
  <a href="/chapter-workbench/general-lectures-electrical-engineering/lecture-07/">Open the workbench<span>Review local concept hits, equation candidates, figure candidates, and hidden-gem quote candidates.</span></a>
  <a href="/diagrams/visual-topic-galleries/transients-surges-oscillations/">Open surge visuals<span>Use guide diagrams for surge reflection, distributed constants, oscillatory transients, and source visual maps.</span></a>
  <a href="/mathematics/equation-atlas/waves-radiation/">Open wave formulas<span>Review frequency, wave length, propagation, and radiation-related formula candidates.</span></a>
</div>
...
- [Protective Device Patent Dossier](/sources/steinmetz-patents/seeded-patent-dossiers/#us1230615a-protective-device)
