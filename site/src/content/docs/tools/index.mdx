...
r_1^2 = \frac{4L}{C}
$$
Use it with the original figure pages and equation page rather than as a replacement for them: [original transient figures](/diagrams/original-transient-electric-phenomena/) and [condenser oscillation frequency and decrement](/mathematics/equations/condenser-oscillation-decrement/).
