...
2. Promote the top concept pages by reading their priority passages and adding stronger prose without inventing claims.
3. Expand equation pages from the equation atlas, beginning with symbolic method, impedance/reactance, admittance, hysteresis, transient terms, and wave velocity.
4. Expand diagram galleries from promoted crops and figure candidate maps.
5. Update the project tracker after each completed workstream, not after each individual page.
