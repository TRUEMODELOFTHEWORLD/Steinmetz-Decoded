...
<div class="source-matrix">
  <a href="/source-texts/radiation-light-and-illumination/lecture-01/">Read Lecture I source<span>Open the source text where the frequency-wavelength bridge begins.</span></a>
  <a href="/diagrams/visual-topic-galleries/radiation-light-spectrum/">Open radiation visuals<span>See the spectrum guide, source visual map, figure candidates, and related formulas.</span></a>
  <a href="/concepts/electric-waves/">Open Electric Waves<span>Trace the concept side of this relation through the corpus.</span></a>
  <a href="/tools/#wave-relation-visualizer">Open wave visualizer<span>Use the interactive tool as a modern explanation aid.</span></a>
</div>
